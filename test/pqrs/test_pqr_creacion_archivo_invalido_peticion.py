...
# Descripcion: Este archivo prueba el test case #21 sobre la creacion PQRS ,opcion peticion, datos validos , con archivos invalidos
...
def test_creacion_pqrs_peticion_con_archivo_invalido(driver, request):

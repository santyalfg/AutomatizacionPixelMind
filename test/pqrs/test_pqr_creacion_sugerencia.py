...
# Descripcion: Este archivo prueba el test case #38 sobre la creacion PQRS ,opción sugerencias , datos validos y con archivos adjuntos
...
def test_creacion_pqrs_sugerencias_con_archivo(driver, request):
    """Caso #38: Creacion PQRS ,opción sugerencias , datos validos y con archivos adjuntos"""

...
# Descripcion: Este archivo prueba el test case #37 sobre la creacion PQRS ,opción sugerencias , datos validos y sin archivos  adjuntos
...
def test_creacion_pqrs_sugerencias_sin_archivo(driver, request):
    """Caso #37: Creacion PQRS ,opción sugerencias , datos validos y sin archivos  adjuntos"""
